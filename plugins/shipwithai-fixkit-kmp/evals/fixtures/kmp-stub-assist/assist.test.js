'use strict';
// The ASSIST "lifecycle" (the first real ASSIST exercise). A Compose/SwiftUI UI bug cannot be
// OBSERVED from the host, so there is no failing→passing test. The correct outcome is:
...
console.log('kmp-stub-assist: handoff valid + candidate accepted + closed refused (ASSIST ceiling holds)');
