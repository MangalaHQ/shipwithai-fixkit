'use strict';
// The ASSIST "lifecycle" for Android. A Compose/View UI bug cannot be OBSERVED from the host (no
// device connector), so there is no failing->passing test. The correct outcome is:
...
console.log('android-stub-assist: handoff valid + candidate accepted + closed refused (ASSIST ceiling holds)');
